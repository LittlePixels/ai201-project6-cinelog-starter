...
patterns as tests/test_collection.py (see Comment 3 / Comment 4 in the PR).
"""
...
def test_add_to_watchlist_nonexistent_film_raises(app, sample_user):
    ...
    Equivalent of test_add_to_collection_nonexistent_film_raises in
...
def test_get_watchlist_returns_newest_first(app, sample_user):
    ...
    with app.app_context():
        ...
        # (Alien sorts first alphabetically — this test fails under title sort.)
